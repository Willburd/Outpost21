...
#define HOLOMAP_AREACOLOR_SCIENCE		"#ad3db585"
...
#define HOLOMAP_AREACOLOR_ARRIVALS		"#2a6fdd38"	// Outpost 21 Edit
#define HOLOMAP_AREACOLOR_ESCAPE		"#FF0000CC"
#define HOLOMAP_AREACOLOR_DORMS			"#CCCC0099"
#define HOLOMAP_AREACOLOR_CIV			"#a2a2a27a"   	//VOREStation Addition, outpost 21 change
