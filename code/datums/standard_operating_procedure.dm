...
/datum/sop_entry/expectations
	...
	body = 	"When on board any station, there are expectations that come with crew jobs based on their role, and their experience. These are the expectations from corporate E-Shui's standards and viewings, and a crewmember may have greater, or lesser, expectations held upon them by their chief of staff. \
			...
			<b>The Captain</b> is responsible for maintaining order on the station, delegating tasks to the heads of staff, and ensuring communication between the heads of staff is appropriate. The Captain is not to perform duties of any department other than command on station, even in a crisis. Their role is to maintain order, and trust their heads of staff to run the station as necessary, despite their overruling authority, to be used to correct inappropriate head of staff behavior. \
			<b>The Head of Personnel</b> is responsible for delegating to all civilian jobs, counting as a head of staff for the civilian department. They are also responsible for access change for interns, and necessary promotion or demotion. They also act as the station Judge should a legal issue be present and elevated beyond IAA handling. As such, the HoP is required to understand corporate law, station interpretation, and context. They report to the captain. \
			<b>The Command Secretary</b> is the scribe and hand of the captain, and the head of personnel. They are to transcribe every head meeting that is called, assist the captain, and head of personnel in all their tasks. They report to the Head of Personnel, but can be utilized by the captain. They are under no obligation to assist the other heads of staff. \
			<hr/><b>Medical:</b><hr/> \
			...
			<b>The Chief Medical Officer</b> is expected to have at least moderate understanding of every medical field; surgery, chemistry, treatment, resleeving, alien crew anatomy and treatment. They are required to have a thorough understanding of patient's rights, triage, and at least two areas of medical. They delegate the doctors under them, take charge during a violet-level event, and if needed, can step in to aid their doctors in any violet-level event. They are encouraged to know how to drive a tank. \
			<b>Doctors</b> are expected to have a thorough understanding of triage, and patient stabilization. They are expected to be able to treat any major or minor injury they come across in normal day to day operations. Doctors includes specializations such as Chemists and Surgeons, who are expected to know their field, as well as general treatment. General doctors are not expected to have a thorough understanding of surgery or chemistry, but are recommended to study and learn at convenience. \
			<b>Paramedics</b> are expected to know patient stabilization, proper medical practice, and have a thorough understanding of the environmental hazards of the Outpost-21 grounds. Their job entails rescuing, and stabilizing all injured crewmembers in order of triage, not by order of chain of command. They are not expected to understand full medical duties of stabilized patients moving to long term treatment. \
			<b>Psychologists</b> are expected to have a thorough and deep understanding of social skills and patient mental health. They are not expected to know further medical knowledge, and are not expected to assist medical during a medical crisis, instead focusing on keeping crew calm and orderly. \
			<hr/><b>Security:</b><hr/> \
			...
			<b>Detectives</b> are in charge of analyzing crime scenes. They are the arm of a warden, and the lowest in the chain of command of security. They are not expected to enforce station law, make arrests, or subdue criminals. They are expected to have a moderate to thorough understanding of their tools for crime scene analysis, a thorough understanding of corporate law, and a moderate understanding of their firearm. \
			<hr/><b>Engineering:</b><hr/> \
			...
			<b>The Quartermaster</b> leads cargo, they are expected to have a thorough understanding of all of cargo's departments: Mining, and Freight. While under most stations they fall under the head of personnel, under E-shui law they are classified as a head of staff themselves, though the lowest head in the chain of command. They are responsible for the productivity of cargo, and to assist in any areas cargo is lacking. \
			<b>Miners</b> are expected to know proper EVA procedures, operation in a null-G and vacuum. They are expected to know how to operate all mining equipment, and how to fly the supplied mining trawler to access the reclamation yard. They are expected to know efficient operation of the ore processor for common materials. \
			<b>Cargo Technicians</b> are expected to know the ordering procedures of the station, and have at least a moderate understanding of department required goods to prevent waste and misuse of controlled cargo. They are expected to know the station layout for manual delivery, and operation of the disposal mail system. They are expected to know the location of the incinerator for trash disposal. \
			<hr/><b>Civilian:</b><hr/> \
			Civilian departments are expected to have general understanding of their chosen task, and their expectations during various condition codes, and to have a basic understanding of the chain of command. But are not expected to perform any extravagant tasks, or expected to have any extravagant knowledge. \
			<b>Chefs, Bartenders, and Botanists</b> are expected to provide the nourishment for the crew. While each one is specialized to their individual task, be it serving drinks, cooking food, or growing ingredients, they are expected to have a minimal understanding of the other areas of their shared department, and to have a moderate understanding of their specialized profession. \
			<b>Chaplains</b> are expected to have a strong understanding of their faith, and good interpersonal skills, acting as a therapist if there is no psychiatrist. They are expected to respond and deal with a station crisis involving a cult or the supernatural to the best of their ability. \
			<b>Janitors</b> are expected to maintain the cleanliness of the station, and to have a moderate understanding of the station layout. Signage must be placed near floors prior to mopping. It is recommended to know at least one language spoken commonly on station. \
			<b>Librarians</b> are expected to keep the library stocked with appropriate books, and to assist any off-station journalists. They are expected to have a thorough understanding of the station's layout and to give tours to new members of the station. They are required to be able to read and write legibly. \
			<b>Interns and Station Guests</b> are expected to understand the environmental hazards of the station. \
...
/datum/sop_entry/not_dying
	title = "A Guide to Not DYING"
	author = "Head of Security, Janik"
	body = 	"Alright officers, stop getting yourself killed. I know you look at these fancy armors and want the shiniest one. That's how you die. Armor choice matters here, so listen the hell up because I can't teach all of you personally. \
			<br/>Each armor type is going to specialize in something, you got four types. <ul><li>Riot</li><li>Bullet</li><li>Ablative</li><li>Combat</li></ul> \
			<br/>--Riot armor is your go-to in most cases, it protects you the most against blunt force trauma, that's punches, animal bites, stuff flying at you, explosives, etc. Not to mention the shield is an extra layer of protection.  \
			...
			<br/>I hope this fixes up some misconceptions, and saves some lives. Please stop getting yourselves killed with trying to look fashionable. I don't care if the riot armor is ugly, wear it."

/datum/sop_entry/triage
	title = "Medical Triage. How to decide who dies"
	author = "Chief Medical Officer, Schale"
	body = 	"In a crisis, as medical, there will invariably reach a point where there are more patients than you can treat. When time is ticking, blood is flowing, and you can't save everyone, how can you make the decision who to save? This chart prevents that question. \
			<hr/> \
