/obj/structure/alien/wall
	...
	//health = 200 // outpost 21 edit - removing xenomorphs, these are just walls now I guess.
	opacity = 1
	density = TRUE
...
/obj/structure/alien/membrane
	...
	opacity = 0
	// health = 120 // outpost 21 edit - removing xenomorphs, these are just walls now I guess.
	density = TRUE
	can_atmos_pass = ATMOS_PASS_NO
