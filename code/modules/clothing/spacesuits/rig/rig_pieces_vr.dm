/obj/item/clothing/head/helmet/space/rig
	sprite_sheets = list(
		...
		//SPECIES_AKULA 			= 'icons/inventory/head/mob_vr_akula.dmi', outpost 21 - race removal
...
/obj/item/clothing/head/helmet/space/rig
	species_restricted = list(SPECIES_HUMAN, SPECIES_SKRELL, SPECIES_TAJ, SPECIES_UNATHI, SPECIES_NEVREAN/*, SPECIES_AKULA*/, SPECIES_SERGAL/*, SPECIES_ZORREN_HIGH*/, SPECIES_VULPKANIN, SPECIES_PROMETHEAN, SPECIES_XENOHYBRID, SPECIES_ALTEVIAN, SPECIES_VOX, SPECIES_TESHARI/*, SPECIES_VASILISSAN*//*, SPECIES_RAPALA*//*, SPECIES_ALRAUNE*//*, SPECIES_GREY_YW*//*ywedit*/)
