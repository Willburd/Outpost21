...
/obj/machinery/vending/fitness
	...
	contraband = list(/obj/item/weapon/reagent_containers/syringe/steroid = 4) //, /obj/item/weapon/reagent_containers/food/drinks/glass2/fitnessflask/proteanshake = 2) // VOREStation Add - Slurpable blobs.  outpost 21 - race removal
...
/obj/machinery/vending/giftvendor
	...
	prices = list(/obj/item/weapon/storage/fancy/heartbox = 15,
					...
					//Outpost 21 add start
					/obj/item/toy/plushie/tinytin = 50,
					//Outpost 21 add end
					//VOREStation Add Start
