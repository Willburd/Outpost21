/datum/lore/codex/category/species
	...
	children = list(
		...
		///datum/lore/codex/page/akula, outpost 21 - race removal
...
/datum/lore/codex/category/drones/add_content()
	...
	permitting adaptability with scarce resources. \
...
/datum/lore/codex/page/drone_classes/add_content()
	...
	<br><br>\
	Occasionally, the average sophont also makes acquaintance with gamma-class drones: those many, nearly mouse-like machines \
	...
	Some even claim they are just as capable of emotions and dreams as humans, as preposterous as that sounds."
