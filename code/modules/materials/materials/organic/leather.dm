...
/datum/material/leather/generate_recipes()
	recipes = list(
		...
		//new /datum/stack_recipe("[display_name] net", /obj/item/weapon/material/fishing_net, 10, time = 5 SECONDS, supplied_material = "[name]", pass_stack_color = TRUE),  // outpost 21 edit - disable fishing
