...
/datum/material/wood/generate_recipes()
	...
	recipes += list(
		...
		//new /datum/stack_recipe("crude fishing rod", /obj/item/weapon/material/fishing_rod/built, 8, time = 10 SECONDS, pass_stack_color = TRUE, recycle_material = "[name]"),  // outpost 21 edit - disable fishing
		...
		new /datum/stack_recipe("primitive Shield", /obj/item/weapon/shield/primitive, 5, time = 12 SECONDS, supplied_material = "[name]", recycle_material = "[name]"),
		new /datum/stack_recipe("wooden bucket", /obj/item/weapon/reagent_containers/glass/bucket/wood, 2, time = 1 SECONDS, supplied_material = "[name]"),
		new /datum/stack_recipe("sticks", /obj/item/stack/material/stick, 1, 5, 5, time = 5 SECONDS, supplied_material = "[name]", pass_stack_color = TRUE, recycle_material = "[name]")
	)
...
/datum/material/wood/stick/generate_recipes()
	recipes = list(
		...
		new /datum/stack_recipe("bonfire", /obj/structure/bonfire, 8, time = 50, supplied_material = "[name]", pass_stack_color = TRUE, recycle_material = "[name]"),
		new /datum/stack_recipe("wood arrow", /obj/item/weapon/arrow/standard, 1,time = 2 SECONDS, recycle_material = "[name]"),
		new /datum/stack_recipe("oar", /obj/item/weapon/oar, 2, time = 30, supplied_material = "[name]", pass_stack_color = TRUE),
		new /datum/stack_recipe("shortbow", /obj/item/weapon/gun/launcher/crossbow/bow/stringless, 3, time = 12 SECONDS, recycle_material = "[name]")
		)
	return
