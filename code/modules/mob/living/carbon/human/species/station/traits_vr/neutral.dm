...
/datum/trait/neutral/stuffing_feeder/unapply(var/datum/species/S,var/mob/living/carbon/human/H)
	..()
	H.verbs -= /mob/living/proc/toggle_stuffing_mode
...
/datum/trait/neutral/alcohol_intolerance_advanced
	...
	cost = 0
	var_changes = list("chem_strength_alcohol" = 3) // 300% as effective if alcohol_mod is set to 1. If it's not 1 in species.dm, update this!
...
/datum/trait/neutral/alcohol_intolerance_basic
	...
	cost = 0
	var_changes = list("chem_strength_alcohol" = 2) // 200% as effective if alcohol_mod is set to 1. If it's not 1 in species.dm, update this!
...
/datum/trait/neutral/alcohol_intolerance_slight
	...
	cost = 0
	var_changes = list("chem_strength_alcohol" = 1.5) // 150% as effective if alcohol_mod is set to 1. If it's not 1 in species.dm, update this!
...
/datum/trait/neutral/alcohol_tolerance_basic
	...
	cost = 0
	var_changes = list("chem_strength_alcohol" = 0.75) // 75% as effective if alcohol_mod is set to 1. If it's not 1 in species.dm, update this!
...
/datum/trait/neutral/alcohol_tolerance_advanced
	...
	cost = 0
	var_changes = list("chem_strength_alcohol" = 0.5) // 50% as effective if alcohol_mod is set to 1. If it's not 1 in species.dm, update this!
...
/datum/trait/neutral/alcohol_immunity
	...
	cost = 0
	var_changes = list("chem_strength_alcohol" = 0.25) // 25% as effective if alcohol_mod is set to 1. If it's not 1 in species.dm, update this!
