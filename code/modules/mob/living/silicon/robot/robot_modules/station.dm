...
/obj/item/weapon/robot_module
	...
	var/channels = list()
	var/networks = list()
	var/languages = list(LANGUAGE_SOL_COMMON = 1, LANGUAGE_TRADEBAND = 1, LANGUAGE_UNATHI = 0, LANGUAGE_SIIK = 0, LANGUAGE_AKHANI = 0, LANGUAGE_SKRELLIAN = 0, LANGUAGE_GUTTER = 0, LANGUAGE_SCHECHI = 0, LANGUAGE_SIGN = 0, LANGUAGE_TERMINUS = 1)//, LANGUAGE_ZADDAT = 0)outpost 21 race removal
	var/sprites = list()
	var/can_be_pushed = 1
	var/no_slip = 0
...
/obj/item/weapon/robot_module/robot/clerical
	...
	languages = list(
					...
					LANGUAGE_TERMINUS	= 1,
					LANGUAGE_SIGN		= 0,
					//LANGUAGE_ZADDAT		= 1, outpost 21 race removal
					)
