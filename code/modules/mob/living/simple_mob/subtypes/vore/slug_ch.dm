...
/mob/living/simple_mob/vore/slug
	...
	maxHealth = 70 //Holy crap why did these have 500 health.
	health = 70
...
/obj/effect/slug_glue
	...
	var/base_escape_time = 30 SECONDS //How long does it take to struggle free? Affected by the victim's size_multiplier.
