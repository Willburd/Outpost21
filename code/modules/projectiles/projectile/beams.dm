...
/obj/item/projectile/beam/lasertag/blue/on_hit(var/atom/target, var/blocked = 0)
	if(ishuman(target))
		...
		if(istype(M.wear_suit, /obj/item/clothing/suit/omnitag) || istype(M.wear_suit, /obj/item/clothing/suit/redtag))
			M.Weaken(5)
	return 1
...
/obj/item/projectile/beam/lasertag/red/on_hit(var/atom/target, var/blocked = 0)
	if(ishuman(target))
		var/mob/living/carbon/human/M = target
		if(istype(M.wear_suit, /obj/item/clothing/suit/omnitag) || istype(M.wear_suit, /obj/item/clothing/suit/bluetag))
			M.Weaken(5)
	return 1
