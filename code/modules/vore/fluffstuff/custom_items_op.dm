...
/obj/item/weapon/flag/laser/jail
	...
	icon = 'icons/vore/custom_items_op.dmi'
	icon_state = "flag_jail"
	icon_override = 'icons/vore/custom_items_op.dmi'
	item_state = "flag_jail"
