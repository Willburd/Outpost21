...
/datum/map
	...
	var/datum/spawnpoint/spawnpoint_died = /datum/spawnpoint/elevator 	// Used if you end the round dead.
	var/datum/spawnpoint/spawnpoint_left = /datum/spawnpoint/elevator 	// Used of you end the round at centcom.
	var/datum/spawnpoint/spawnpoint_stayed = /datum/spawnpoint/elevator 	// Used if you end the round on the station.
	...
	var/default_law_type = /datum/ai_laws/eshui_standard // The default lawset use by synth units, if not overriden by their laws var.
